.. _lib.liveintersect.iot:

****************
Liveintersect IoT
****************

`LiveIntersect <https://esprida.com/platform/>`_ is an IoT application enablement platform which is designed to help build Connected Products and IoT solutions.  The IoT enablement platform provides vital capabilities including:
...
Using the Zerynth Studio, and the LiveIntersect client library you can quickly build IoT solutions that can run on many `microcontrollers. <https://www.zerynth.com/zerynth-supported-devices/>`_  
